# POKART data structure and terminal logic

## Terminal logic

- prototype
  at https://www.sketch.com/s/7cb888f5-cf20-47fe-a309-741e35fe67fc/prototype/a/37A1C3DD-95A4-41B9-9774-A4567542C1DD
  ![prototype.png](prototype.png)

## PDF Documents

- SAMBA server at 192.168.0.233
  ![location.png](location.png)
- settings (specific PFD files for products) on xmost web page
...
| AXIOM.FDB.PRACOVNIK.CARKOD_PR   | system.users.barcode   jahoda je boss |
...
| AXIOM.FDB.OBL_TPV_OPR.STR_ID         | system.pokart_order_information_operations.workplace_name       | Stroj        |
...
- Analog inputs are connected to the unit:
    ...
    - I0.10 - temperature sensor -30 to 60 degrees Celsius (The temperature sensor is installed in the area of the
